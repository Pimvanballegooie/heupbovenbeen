...
def geocodeer(adres):
    try:
        ...
        r = urllib.request.Request(u, headers={"User-Agent": "HeupBovenbeenNetwerk/1.0"})
...
# Subcategorieen die relevant zijn voor het Heup Bovenbeen Netwerk:
# 43 = Heup, lies en bovenbeen (eigen domein), 46-49 = gedeelde been-thema's (zie beenklachten.net)
RELEVANTE_SUBCATS = {43, 46, 47, 48, 49}
...
print(f"{len(praktijken)} praktijken relevant voor Heup Bovenbeen Netwerk (subcats {sorted(RELEVANTE_SUBCATS)})")
