...
def maak_protocol_titel(protocol_naam, niveau):
    ...
    return f"{protocol_naam} - {label} | Heup Bovenbeen Netwerk"
...
def maak_meta_description(protocol_naam, niveau, body_schoon):
    ...
    return f"{intro} {protocol_naam.lower()}. Fysiotherapie - Heup Bovenbeen Netwerk."
...
<head>
  ...
  <link rel="canonical" href="https://heupbovenbeen.net/protocollen/{protocol_id}-{niveau}.html" />
  ...
  {{
    ...
    "url": "https://heupbovenbeen.net/protocollen/{protocol_id}-{niveau}.html",
    "inLanguage": "nl",
    "isPartOf": {{"@type": "WebSite", "name": "Heup Bovenbeen Netwerk", "url": "https://heupbovenbeen.net"}}{structured_data_extra}
  }}
  </script>
</head>
<body>
<header>
  <div class="header-inner">
    <a href="../index.html" class="logo">
      <img class="logo-icon" src="../BKN_Logo.png" alt="Heup Bovenbeen Netwerk logo" />
      <div class="logo-text">Heup Bovenbeen Netwerk</div>
    </a>
    <nav>
...
<footer>
  <p>&copy; 2026 Heup Bovenbeen Netwerk &nbsp;&middot;&nbsp; <a href="../index.html">Home</a> &nbsp;&middot;&nbsp; <a href="../protocollen.html">Protocollen</a></p>
</footer>
</body>
</html>'''
    ...
    for niveau, doc_id in protocol['niveaus'].items():
        ...
        try:
            ...
            if body_match:
                ...
                zone_naam_display = ZONES.get(protocol.get('zone', ''), 'Heup & bovenbeen')
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Alle behandelprotocollen heup & bovenbeen - Heup Bovenbeen Netwerk</title>
  <meta name="description" content="Overzicht van alle behandelprotocollen voor heup-, lies- en bovenbeenaandoeningen. Heupartrose, liesblessures, bursitis, hamstringblessures en meer." />
  <style>
    @font-face {
      font-family: 'Inter';
      src: url('fonts/inter-v20-latin-300.woff2') format('woff2');
...
<div class="hero">
  <h1>Alle behandelprotocollen<br><em>heup & bovenbeen</em></h1>
  ...
  <div class="zoekbalk-wrap">
    <div class="zoekbalk">
      <input type="text" id="zoek-input" placeholder="Zoek bijv. heupartrose, liesblessure, bursitis..." oninput="zoek()" />
...
<div class="filter-wrap">
  ...
  <button class="zone-btn" onclick="filterZone(this, \'heup\')">🦴 Heup</button>
  <button class="zone-btn" onclick="filterZone(this, \'lies\')">🔗 Lies</button>
  <button class="zone-btn" onclick="filterZone(this, \'bovenbeen\')">🦵 Bovenbeen</button>
</div>
<div class="container">
...
<footer>
  <p>&copy; 2026 Heup Bovenbeen Netwerk &nbsp;&middot;&nbsp; <a href="index.html">Terug naar home</a></p>
</footer>
<script>
...
sitemap_urls = [
    f'  <url><loc>https://heupbovenbeen.net/</loc><changefreq>monthly</changefreq><priority>1.0</priority></url>',
    f'  <url><loc>https://heupbovenbeen.net/protocollen.html</loc><lastmod>{vandaag}</lastmod><changefreq>weekly</changefreq><priority>0.9</priority></url>',
    f'  <url><loc>https://heupbovenbeen.net/index.html#locaties</loc><changefreq>monthly</changefreq><priority>0.7</priority></url>',
    f'  <url><loc>https://heupbovenbeen.net/partners.html</loc><changefreq>monthly</changefreq><priority>0.6</priority></url>',
]

for p in protocol_data:
    for niveau in p['teksten'].keys():
        url = f"https://heupbovenbeen.net/protocollen/{p['id']}-{niveau}.html"
...
robots = """User-agent: *
Allow: /
Sitemap: https://heupbovenbeen.net/sitemap.xml"""
